...
% Date: 02/02/2026
% JPEG Compression using DCT (high compression case)

clc;
clear all;
close all;

I = imread("bird_image.jpg");
if size(I,3) == 3
    I = rgb2gray(I);
end
I = double(I);
% Reading the image, converting to grayscale if needed,
% and changing data type for mathematical operations.
